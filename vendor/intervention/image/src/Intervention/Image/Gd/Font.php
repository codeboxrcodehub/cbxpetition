...
class Font extends \CbxPetitionScoped\Intervention\Image\AbstractFont
{
    /**
    ...
    {
        throw new \CbxPetitionScoped\Intervention\Image\Exception\NotSupportedException("Kerning is not supported by GD driver.");
    }
}

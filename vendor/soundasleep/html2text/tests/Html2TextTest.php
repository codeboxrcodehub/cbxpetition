...
class Html2TextTest extends \PHPUnit\Framework\TestCase
{
    ...
    function doTestWithResults(string $test, string $result, $options = []) : void
    {
        ...
        $expected = \CbxPetitionScoped\Soundasleep\Html2Text::fixNewlines(\file_get_contents($txt));
        $output = \CbxPetitionScoped\Soundasleep\Html2Text::convert($input, $options);
        if ($output != $expected) {
...
\class_alias('CbxPetitionScoped\\Html2TextTest', 'Html2TextTest', \false);

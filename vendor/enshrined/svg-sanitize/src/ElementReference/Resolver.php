...
namespace CbxPetitionScoped\enshrined\svgSanitize\ElementReference;

use CbxPetitionScoped\enshrined\svgSanitize\data\XPath;
use CbxPetitionScoped\enshrined\svgSanitize\Exceptions\NestingException;
use CbxPetitionScoped\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath

...
do_action( 'cbxpetition_email_header', $email_heading, $email ); ?>
    <div class="content-section">
        ...
        <p class="message">
            ...
            <?php echo esc_html__( 'We’re happy to inform you that your signature for the petition "{petition}" has been successfully approved! Thank you for taking a stand and supporting this cause.', 'cbxpetition' ); ?>
        </p>

...
if ( ! is_user_logged_in() ):
    ...
    $guest_html       .= '<p class="cbx-title-login cbxpetition-title-login">' . wp_kses( __( 'Do you have account, <a role="button" class="guest-login-trigger cbxpetition-guest-login-trigger" href="#">please login</a>', 'cbxpetition' ), [
                    'a' => [
                            'href'  => [],
                            'role'  => [],
                            'class' => [],

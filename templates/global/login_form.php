...
if ( ! is_user_logged_in() ):
	...
	$guest_html .= '</div>';
	//echo '<div class="cbx-chota"><div class="container"><div class="row"><div class="col-12 petition_login_regi_box">'.$guest_html.'</div></div></div></div>'; /* translators: %1$s: Resume text , %2$s: Resume number  */

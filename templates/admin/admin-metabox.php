        ...
        <div id="cbxpetition_dashboard_tab_wrap">
            ...
            <div id="cbxpetition_dashboard_tab_contents">
                    ...
                    if ( $petition_id > 0 ):
                        ...
                        <div class="cbxpetition_dashboard_edit_field_group">
                            ...
                            <input required type="number" min="0"
                                   ...
                                   id="cbxpetition_dashboard_edit_signature_target"
                                   name="cbxpetitionmeta[signature-target]"
                ...
                <div id="cbxpetition_dashboard_content_photo" class="cbxpetition_dashboard_content_tab">
                    ...
                    echo '<h3 class="cbxpetition_fields_heading">' . esc_html__( 'Petition Photos', 'cbxpetition' ) . '<span class="small">(' . esc_attr( $max_photos_title ) . ')</span>' . wp_kses( $delete_all_photos, [
                                    'a' => [
                                            'class' => [],
                                            'href'  => []
                                    ]

                    ...
                    <div class="wp-heading-wrap">
                        ...
                        <div class="wp-heading-wrap-right pull-right">
                            <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=cbxpetition' ) ); ?>"
                               class="button primary icon icon-inline icon-right  mr-5"><i
                                        class="cbx-icon"><?php echo $plus_svg; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></i><span
                                        class="button-label"><?php esc_html_e( 'New Petition', 'cbxpetition' ); ?></span></a>
                                ...
                                <?php if ( ! is_null( $sign_info ) ) : ?>
                                    <form data-busy="0" id="cbxpetition_sign_edit_form"
                                        ...
                                        <div class="cbxpetition-signform-field">
                                            ...
                                            <input class="disabled" readonly id="first_name" type="text"
                                                   name="first_name"
                                        ...
                                        <?php if ( $sign_info['mod_date'] !== null ): ?>
                                            <div class="cbxpetition-signform-field">
                                                ...
                                                <input class="disabled" readonly id="mod_date" type="text"
                                                       name="mod_date"
                                                       value="<?php echo esc_attr( PetitionHelper::datetimeShowingFormat( $sign_info['mod_date'] ) ); ?>"/>
                                            </div>
                                        <?php endif; ?>
                                        <div class="cbxpetition-signform-field">
                                            <label for="signature_comment"><?php esc_html_e( 'Comment(Optional)', 'cbxpetition' ); ?></label>
                                            <textarea
                                                    name="comment" id="signature_comment"
                                                    class="regular-text cbxpetition_sign_comment"
                                                    rows="10"
                                                    cols="50"><?php echo esc_textarea( wp_unslash( $comment ) ); ?></textarea>
                                        </div>
                                        <div class="cbxpetition-signform-field">
                                            <label for="location"><?php esc_html_e( 'Location(Optional)', 'cbxpetition' ); ?></label>

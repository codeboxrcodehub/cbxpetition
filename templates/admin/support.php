...
$plugin_url = PetitionHelper::url_utmy( 'https://codeboxr.com/product/cbx-petition-for-wordpress/' );
$doc_url    = PetitionHelper::url_utmy( 'https://codeboxr.com/doc/cbxpetition-doc/' );
?>
    <div class="wrap cbx-chota cbxpetition-page-wrapper cbxpetition-support-wrapper" id="cbxpetition-support">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="wp-heading-inline wp-heading-inline-cbxpetition">
                        <?php esc_html_e( 'Petition: Support & Docs', 'cbxpetition' ); ?>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="cbx-backend-card">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Get Free & Pro Addons', 'cbxpetition' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                                            ...
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                   target="_blank"> <img
                                                            ...
                                                            alt="CBX Petition for WordPress"/> </a>

                                            </div>
                                            <div class="feature-card-description">
                                                <h3>
                                                    <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                       target="_blank">CBX Petition Pro Addon</a></h3>
                                                <p>Pro features for CBX Petition plugin.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Third Party plugin Integration', 'cbxpetition' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            <p>
								...
								<?php esc_html_e( 'Coming Soon ...', 'cbxpetition' ); ?></p>
                        </div>
                    </div>
                </div>-->
                                ...
                                <ul>
                                    <li>
                                        <a rel="external" target="_blank"
                                           href="https://comforterp.com/product/comfort-accounting-accounting-solution-for-wordpress">Comfort
                                            Accounting</a></li>
                                    <li>
                                        <a rel="external" target="_blank"
                                           href="https://comforterp.com/product/comfort-inventory-and-invoice-complete-invoice-plugin-for-wordpress">Comfort
                                            Inventory & Invoice</a></li>
                                    <li><a rel="external" target="_blank"
                                           href="https://comforthrm.com/product/comfort-resume-wordpress-resume-builder-plugin">Comfort
                                            Resume</a></li>
                                    <li><a rel="external" target="_blank"
                                           href="https://comforthrm.com/product/comfort-job-wordpress-job-board-plugin">Comfort
                                            Job Board</a></li>
                                    <li><a rel="external" target="_blank"
                                           href="https://comforthrm.com/product/comfort-job-application-plugin-for-wordpress">Comfort
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>[new] New email template system</li>
                                    <li>[new] Two new email templates</li>
                                    <li>[new] On submit signature shows a message</li>
                                    <li>[updated] Core plugin 2.0.15 released</li>
                                    <li>[updated] Plugin check V2.0.0 coding standard compatible</li>
                                    <li>[updated] WordPress 7.0 Compatible</li>
                                    <li>[misc] Lots of ui/ux related improvement</li>
                                    <li>[misc] Petition archive template improved</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>Plugin setting's left menu hides in some cases(fixed)</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Changelog Pro Addon', 'cbxpetition' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>[new] Adopted new email template with core</li>
                                    <li>[updated] Core plugin 2.0.15 released</li>
                                    <li>[updated] Plugin check V2.0.0 coding standard compatible</li>
                                    <li>[updated] WordPress 7.0 Compatible</li>
                                </ul>
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>[updated] Uncanny integration for on signature submit for petition - added
                                        category taxonomy condition
                                    </li>
                ...
                <div class="col-6">
                    <div class="cbx-backend-card dashboard-support">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Help & Supports', 'cbxpetition' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
                                    ...
                                    <?php esc_html_e( 'CBX Petition for WordPress', 'cbxpetition' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
                                    ...
                                    <?php esc_html_e( 'Documentation & User Guide', 'cbxpetition' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxpetition/reviews/#new-post"
                                   target="_blank">
                                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <?php esc_html_e( 'Review & Rate CBX Petition for WordPress', 'cbxpetition' ); ?>
                                </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxpetition/" target="_blank">
                                    ...
                                    <?php esc_html_e( 'Core Plugin Support', 'cbxpetition' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
                                    ...
                                    <?php esc_html_e( 'Pro Addon Support', 'cbxpetition' ); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Other WordPress Plugins', 'cbxpetition' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <?php
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Codeboxr News Updates', 'cbxpetition' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <?php
                            $items = PetitionHelper::codeboxr_news_feed();

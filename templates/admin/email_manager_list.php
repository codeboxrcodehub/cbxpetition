...
?>
    <div class="section_header row">
        <div class="col-12 section_header_l">
            ...
            <p><?php esc_html_e( 'Here are the list of available email notifications. Please note that, few notification may sent from background without any setting based on the type of not.', 'cbxpetition' ); ?></p>
        </div>
    ...
    <div id="email_manager_listing_wrapper">
        ...
        <table class="table table-bordered table-striped table-hover" id="cbxpetition_email_items">
            ...
            foreach ( $emails as $email ):
                ...
                <tr>
                    <td>
                    <span aria-label="<?php echo esc_attr( $status_title ); ?>" data-balloon-pos="up"
                          class="button cbxpetition_email_status <?php echo esc_attr( $button_status_class ); ?> outline secondary icon icon-only">
                        <i class="cbx-icon">

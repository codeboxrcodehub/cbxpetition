...
?>
    <!--<div class="cbx-chota">-->
    <div class="cbxpetition_signform_wrapper" id="cbxpetition_signform_<?php echo absint($petition_id); ?>">
        <?php
                            ...
                            <form action="#" data-busy="0" class="cbx_form_wrapper cbxpetition-signform" method="POST"
                                ...
                                <div class="cbxpetition-signform-field">
                                    ...
                                    ?> cols="30" rows="6"
                                       ...
                                       placeholder="<?php esc_attr_e( 'I’m signing because… (optional)', 'cbxpetition' ); ?>"></textarea>

                                </div>
                                <div class="cbxpetition-signform-field">
                                    <label class="cbxpetition-signform-field-label"
                                           for="cbxpetition-location"><?php esc_attr_e( 'Location/Address(optional)', 'cbxpetition' ); ?></label>
                                    <input type="text"  class="cbxpetition-signform-field-input cbxpetition-signform-field-text cbxpetition-signform-field-location"
                                       name="cbxpetition-location"    id="cbxpetition-location"  placeholder="<?php esc_attr_e( 'Location/address', 'cbxpetition' ); ?>" />
                                ...
                                <p class="text-center">
                                    <button type="submit"
                                            class="ld-ext-right cbxpetition_button primary cbxpetition-sign-submit"><?php esc_html_e( 'Sign This Petition', 'cbxpetition' ); ?>
                                ...
                                <input type="hidden" name="cbxpetition-id"
                                       value="<?php echo absint( $petition_id ) ?>"/>

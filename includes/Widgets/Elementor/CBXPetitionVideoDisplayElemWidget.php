...
/**
 * CBX Petition Video Display Widget
 */
class CBXPetitionVideoDisplayElemWidget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'cbxpetition_video_display';
	}//end method get_name
	...
	public function get_title() {
		return esc_html__( 'CBX Petition Video', 'cbxpetition' );
	...
	public function get_icon() {
		return 'cbxpetition-video-display-icon';
	}//end method get_icon
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_cbxpetition_video_display',
			[
				'label' => esc_html__( 'CBXPetition Video Display Widget Setting', 'cbxpetition' ),
			]
		);
	...
	protected function render() {
		...
		if ( absint( $id ) <= 0 && ( false !== get_post_status( $id ) ) ) {
			...
			echo do_shortcode( '[cbxpetition_video petition_id="' . $id . '"]' );
		}
...
}//end class CBXPetitionVideoDisplayElemWidget

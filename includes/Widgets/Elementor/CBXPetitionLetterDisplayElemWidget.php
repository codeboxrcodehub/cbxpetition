 ...
 * CBX Poll Widget
 */
class CBXPetitionLetterDisplayElemWidget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'cbxpetition_letter_display';
	}//end method get_name
	...
	public function get_title() {
		return esc_html__( 'CBX Petition Letter', 'cbxpetition' );
	...
	public function get_icon() {
		return 'cbxpetition-letter-display-icon';
	}//end method get_icon
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_cbxpetition_letter_display',
			[
				'label' => esc_html__( 'CBXPetition Letter Display Widget Setting', 'cbxpetition' ),
			]
		);
	...
	protected function render() {
		...
		if ( absint( $id ) <= 0 && ( false !== get_post_status( $id ) ) ) {
			...
			echo do_shortcode( '[cbxpetition_letter petition_id="' . $id . '"]' );
		}
...
}//end method CBXPetitionLetterDisplayElemWidget

...
class CBXSetting {
    ...
    function callback_multicheck( $args, $value = null ) {
        ...
        if ( ! PetitionHelper::is_associative_array( $options_arr ) ) {
            $options = PetitionHelper::convert_to_associative_array( $options_arr );
        } else {
            $options = $options_arr;
        }
    ...
    /**
     * Displays a select box for page select for a settings field
     *
     * @param $args
     * @param $value
     *
    ...
    function callback_repeat( $args ) {
        ...
        if ( $allow_new ) {
            $html .= '<p style="text-align: center;"><a data-index="' . absint( $index ) . '" data-busy="0" data-field_name="' . $args['name'] . '" data-section_name="' . $section_name . '" data-option_name="' . $option_name . '" class="button secondary form-table-fields-new" href="#">' . esc_html__( 'Add New', 'cbxpetition' ) . '</a></p>';
        }
    ...
    /**
     * Displays a text field for slug for a settings field
     *
     * @param $args
     * @param $value
     *
     * @return void
     */
    function callback_slug( $args, $value = null ) {

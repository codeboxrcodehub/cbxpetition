...
Note: Full source code available at [Github Repo](https://github.com/codeboxrcodehub/cbxpetition)
...
1. Petition banner [cbxpetition_banner]
2. Petition statistics [cbxpetition_stat]
3. Petition video [cbxpetition_video]
4. Petition photos [cbxpetition_photos]
5. Petition letter [cbxpetition_letter]
6. Petition signature form [cbxpetition_signform]
7. Petition signature listing [cbxpetition_signatures]
...
10. Full Petition Display [cbxpetition]  (New in V1.0.1) to display full petition inside any page or post
11. Any shortcode should have but missing? let us know

**Classic Widgets**

1. Petition Summary Classic Widget [New in V1.0.2]
...
3. Petition photos widget compatible with shortcode  [cbxpetition_photos]
4. Petition video widget compatible with shortcode [cbxpetition_video]
5. Petition letter widget compatible with shortcode [cbxpetition_letter]
6. Petition signature form widget compatible with shortcode [cbxpetition_signform]
7.Petition signature listing widget compatible with shortcode [cbxpetition_signatures]
...
9. Petition Summary widget compatible with shortcode [cbxpetition_summary]
10. Petition Latest Listing widget compatible with shortcode [cbxpetition_latest]
11. Any block widget missing? let us know
...
-  Enable/Disable and Email Template
-  Send signature to petition recipients
...
== Changelog ==
= 2.0.15 =
* [new] New email template system
* [new] Two new email templates
* [new] On submit signature shows a message
* [updated] Core plugin 2.0.15 released
* [updated] Plugin check V2.0.0 coding standard compatible
* [updated] WordPress 7.0 Compatible
* [misc] Lots of ui/ux related improvement
* [misc] Petition archive template improved
...
* [updated] Pro addon plugin V2.0.1 released and compatible

= 2.0.2 =
* [new] All shortcode and classic widget compatible block editor widgets added
* [updated] Hooks and shortcode loading classes are improved.
